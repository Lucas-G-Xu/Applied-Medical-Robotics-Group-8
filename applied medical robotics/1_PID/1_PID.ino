...
float demandPositionInDegrees_m1 = 0*WGR; // multiply by 30 to account for gear
float demandPositionInDegrees_m2 = -0*WGR; //always negative to be in the same direction
